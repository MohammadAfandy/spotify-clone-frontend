    ...
    <div className="flex flex-col w-full">
      <div className="text-sm">
        <div className="flex border-b border-gray-500 py-2">
          <div className="flex justify-center mr-2" style={{ flexBasis: '5%' }}>#</div>
          <div className="flex flex-grow">TITLE</div>
          {showAlbum && <div className="flex mr-2" style={{ flexBasis: '30%' }}>
            {!isIncludeEpisode && `ALBUM`}
            {isIncludeEpisode && `ALBUM OR PODCAST`}
          </div>}
          {showDateAdded && <div className="flex mr-2" style={{ flexBasis: '15%' }}>DATE ADDED</div>}
          <div className=" mr-2" style={{ flexBasis: '5%' }}></div>
          {onRemoveFromPlaylist && <div className=" mr-2" style={{ flexBasis: '5%' }}></div>}
