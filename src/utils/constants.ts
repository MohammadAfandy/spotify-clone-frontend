...
export const SPOTIFY_LOGO = '/icons/spotify-icon.png';
export const SPOTIFY_LOGO_WHITE = '/icons/spotify-icon-white.png';
export const SPOTIFY_LOGO_BLACK = '/icons/spotify-icon-black.png';
